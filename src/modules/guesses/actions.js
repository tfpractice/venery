...
import { DECREMENT_REMAINING, GUESS_LETTER, INCREMENT_REMAINING, RESET_GUESSES,
   RESET_REMAINING, } from './constants';
...
export const resetGuesses = () =>
    ({ type: RESET_GUESSES, curry: resetLetters(), });
